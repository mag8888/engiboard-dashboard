    ...
    updates: [
      {
        ...
        date: "2026-05-03",
        kind: "milestone",
        text: "L-08 Documentation: docs/USER_GUIDE.md (15 sections, full feature walkthrough) — done",
        prUrl: "https://github.com/mag8888/engiboard-desktop/blob/main/docs/USER_GUIDE.md",
      },
      {
        id: "U-S8-02",
        date: "2026-05-03",
        kind: "milestone",
        text: "L-10 Privacy Policy + ToS — done. docs/PRIVACY.md + docs/TERMS.md committed.",
        prUrl: "https://github.com/mag8888/engiboard-desktop/blob/main/docs/PRIVACY.md",
      },
      {
        id: "U-S8-03",
        date: "2026-05-03",
        kind: "info",
        text: "Bonus polish: v0.1.23 — Bulk task select + actions (bulk delete, bulk status change). Не в §15 ТЗ, но критично для UX.",
        prUrl: "https://github.com/mag8888/engiboard-desktop/releases/tag/v0.1.23",
      },
    ],
    tasks: [
      { id: "L-01", priority: "L", status: "blocked", title: "Все 4 артефакта подписаны (.dmg ARM/Intel + .exe + .msi)" },
      { id: "L-02", priority: "L", status: "blocked", title: "Notarization прошла (spctl assess accepted)" },
      { id: "L-03", priority: "L", status: "blocked", title: "Auto-update проверен на тестовом релизе (v0.99 → v1.0)" },
      { id: "L-04", priority: "L", status: "blocked", title: "Supabase RLS audit — один юзер не видит данные другого" },
      ...
      { id: "L-07", priority: "L", status: "pending", title: "Экспорт PDF проекта 50 задач <10 сек" },
      {
        ...
        priority: "L",
        status: "done",
        title: "Документация: install guide + user manual + FAQ",
        description: "docs/USER_GUIDE.md — 15 разделов, install/auth/capture/tasks/bulk/filters/PDF/CSV/Slack/customization/sidebar/persistence/troubleshooting/keyboard shortcuts/feedback.",
        prUrl: "https://github.com/mag8888/engiboard-desktop/blob/main/docs/USER_GUIDE.md",
      },
      { id: "L-09", priority: "L", status: "pending", title: "Landing page (engiboard.app или подобный домен)" },
      {
        ...
        description: "docs/PRIVACY.md (privacy-first, no telemetry) + docs/TERMS.md (MIT-style, as-is, DE jurisdiction). README обновлён ссылками.",
        prUrl: "https://github.com/mag8888/engiboard-desktop/blob/main/docs/PRIVACY.md",
      },
