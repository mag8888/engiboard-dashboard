  ...
  },
  {
    ...
    updates: [
      {
        ...
        date: "2026-05-03",
        kind: "deploy",
        text: "v0.1.16 — P2-3 Dark mode shipped (CSS vars + sun/moon toggle + ⌘⇧T + localStorage + prefers-color-scheme)",
      ...
      },
      {
        ...
        date: "2026-05-03",
        kind: "deploy",
        text: "v0.1.17 — P2-5 CSV import shipped (parse, header-driven, bulk task create with status name mapping)",
    ...
    tasks: [
      ...
      { id: "P2-2", priority: "P2", status: "pending", title: "Customizable keyboard shortcuts" },
      {
        ...
        description: "60+ хардкод цветов заменены на var(--bg)/var(--surf). Sun/moon icon в sidebar. Кнопка + ⌘⇧T + localStorage + prefers-color-scheme fallback.",
      ...
      { id: "P2-4", priority: "P2", status: "pending", title: "Localization RU / EN (i18n.json + auto-detect)" },
      {
        ...
        description: "Парсер с поддержкой quoted полей. Header-driven (title обязателен; project/status/week/notes опционально). 8 status name aliases.",
